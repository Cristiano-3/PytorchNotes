...
class Rescale(object):
    ...
    Args:
    output_size (tuple or list): Desired output size. If tuple, output is matched to output_size.
...
class RandomCrop(object):
    ...
    Args:
    output_size (tuple or int): Desired output size. If square crop is made.
    """
    def __init__(self, output_size):
        assert isinstance(output_size, (int, tuple))
...
# which operate on PIL.Image like RandomHorizontalFlip, Scale, are also available. 
# You can use these to write a dataloader like this:
